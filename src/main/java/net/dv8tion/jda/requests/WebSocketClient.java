...
public class WebSocketClient extends WebSocketAdapter implements WebSocketListener
{
    ...
    public void onDisconnected(WebSocket websocket, WebSocketFrame serverCloseFrame, WebSocketFrame clientCloseFrame, boolean closedByServer)
    {
        ...
        if (!shouldReconnect)        //we should not reconnect
        {
            ...
            api.getEventManager().handle(new ShutdownEvent(api, OffsetDateTime.now(), null));
        }
        else
        {
            api.getEventManager().handle(new DisconnectEvent(api, serverCloseFrame, clientCloseFrame, closedByServer, OffsetDateTime.now(), null));
            reconnect();
        }
    }
